...
import gitau.dev.talinserver.Common.DirectionJSONParser;
        ...
        LocationListener
{
    ...
    private final static int LOCATION_PERMISSION_REQUEST = 9999;
    ...
    private void displayLocation() {
        ...
        else
        {
            ...
            if(mLastLocation !=null)
            {
                ...
                //Add marker to our location and move the camera
                LatLng ourLocation = new LatLng(latitude,longitude);
                mMap.addMarker(new MarkerOptions().position(ourLocation).title("YOU"));
                mMap.moveCamera(CameraUpdateFactory.newLatLng(ourLocation));
                mMap.animateCamera(CameraUpdateFactory.zoomTo(17.0f));



                //After we add marker for our location , add marker for this Order and draw Route;
                drawRoute(ourLocation,Common.currentRequest.getAddress());
...
//                Toast.makeText(this, "Couldn't get the Location", Toast.LENGTH_SHORT).show();
    ...
    private void drawRoute(final LatLng ourLocation, String address) {
